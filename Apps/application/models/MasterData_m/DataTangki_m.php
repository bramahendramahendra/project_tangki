...
class DataTangki_m extends CI_Model {
	...
	{
		$this->db->select('a.id, b.id as id_facility_management, c.id as id_gedung, b.facility_management, c.gedung, c.lokasi, c.jenis_tangki, a.sisa_bahan_bakar, a.kapasitas_bahan_bakar');
