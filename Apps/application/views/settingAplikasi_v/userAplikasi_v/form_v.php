            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?=form_open_multipart((isset($dataView['pages'])&&$dataView['pages']=="update"?$dataView['urlUpdate']:$dataView['urlCreate']), 'class="formData" id="formData"');?>    
                                <?php echo "<pre>";var_dump($dataUpdate);echo "</pre>";?>
